...
import type { ThemeModeType } from '@tni/types';

import { MoonStar, Sun, SunMoon } from '@tni/icons';
...
import { ToggleGroup, ToggleGroupItem, TniTooltip } from '@tni-core/shadcn-ui';
...
<template>
  <div>
    <TniTooltip :disabled="!shouldOnHover" side="bottom">
      <template #trigger>
        <ThemeButton
          :model-value="isDark"
          type="icon"
