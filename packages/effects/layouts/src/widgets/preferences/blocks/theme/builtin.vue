...
import type { BuiltinThemePreset } from '@tni/preferences';
import type { BuiltinThemeType } from '@tni/types';

import { computed, ref, watch } from 'vue';

import { UserRoundPen } from '@tni/icons';
import { $t } from '@tni/locales';
import { BUILT_IN_THEME_PRESETS } from '@tni/preferences';
import { convertToHsl, TinyColor } from '@tni/utils';
