...
import type { TabDefinition } from '@tni/types';

import type { IContextMenuItem } from '@tni-core/tabs-ui';
...
import { getTabKey, useAccessStore, useTabbarStore } from '@tni/stores';
import { filterTree } from '@tni/utils';
