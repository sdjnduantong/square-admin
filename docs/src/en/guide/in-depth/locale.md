...
import { updatePreferences } from '@tni/preferences';
...
- Do not place business translation texts inside `@tni/locales` to better manage business and general translation texts.
...
{
  "about": {
    "desc": "Tni Admin is a modern management template."
  }
}
````
...
With `@tni/locales`, you can easily use translation texts:
