...
With the permission codes, you can use the `AccessControl` component and API provided by `@tni/access` to show and hide buttons.

#### Component Method

```vue
<script lang="ts" setup>
import { AccessControl, useAccess } from '@tni/access';
...
```vue
<script lang="ts" setup>
import { AccessControl } from '@tni/access';
</script>
...
```vue
<script lang="ts" setup>
import { useAccess } from '@tni/access';
