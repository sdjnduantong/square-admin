...
- The icons in the project are mainly provided by the `@tni/icons` package. It is recommended to manage them within this package for unified management and maintenance.
...
import { createIconifyIcon } from '@tni-core/icons';
...
import { MdiKeyboardEsc } from '@tni/icons';
</script>
...
```vue
<script setup lang="ts">
import { SvgTestIcon } from '@tni/icons';
</script>
