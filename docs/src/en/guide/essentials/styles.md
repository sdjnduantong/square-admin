...
The style files in the project are stored in `@tni/styles`, which includes some global styles, such as reset styles, global variables, etc. It inherits the styles and capabilities of `@tni-core/design` and can be overridden according to project needs.
...
import { useNamespace } from '@tni/hooks';
