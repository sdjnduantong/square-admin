...
静态路由和动态路由都会走权限控制，可以通过配置路由的 `meta` 属性中的 `authority` 字段来控制权限，可以参考[路由权限控制](https://github.com/tnijs/vue-tni-admin/blob/main/playground/src/router/routes/modules/demos.ts)。
...
import { TNI_LOGO_URL } from '@tni/constants';
...
const routes: RouteRecordRaw[] = [
  {
    meta: {
      ...
      icon: TNI_LOGO_URL,
      order: 9999,
      title: $t('page.tni.title'),
    },
    name: 'TniProject',
    path: '/tni-admin',
    redirect: '/tni-admin/about',
    children: [
      {
        name: 'TniAbout',
        path: '/tni-admin/about',
        component: () => import('#/views/_core/about/index.vue'),
        meta: {
          badgeType: 'dot',
          badgeVariants: 'destructive',
          icon: 'lucide:copyright',
          title: $t('page.tni.about'),
        },
      },
    ],
  },
