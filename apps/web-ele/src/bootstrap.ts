...
async function bootstrap(namespace: string) {
  ...
  // 注册Tni提供的v-loading和v-spinning指令
  registerLoadingDirective(app, {
    loading: false, // Tni提供的v-loading指令和Element Plus提供的v-loading指令二选一即可，此处false表示不注册Tni提供的v-loading指令
    spinning: 'spinning',
  });
